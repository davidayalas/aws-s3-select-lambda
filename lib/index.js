...
const _JSON_TYPE = process.env.JSON_TYPE || "DOCUMENT";
  ...
  const params = {
    ...
    "InputSerialization" : {
      ...
      [_TYPE] : {
        ...
        ..._CSV_FIELD_DELIMITER && {"FieldDelimiter":_CSV_FIELD_DELIMITER},
        ..._CSV_COMMENTS && {"Comments":_CSV_COMMENTS},
        ..._CSV_QUOTE_CHARACTER && {"QuoteCharacter":_CSV_QUOTE_CHARACTER},
        ..._CSV_QUOTE_ESCAPE_CHARACTER && {"QuoteEscapeCharacter":_CSV_QUOTE_ESCAPE_CHARACTER}
      }
    },
    ..._TYPE==="JSON" && {"OutputSerialization": {"JSON":{}}},
  };
